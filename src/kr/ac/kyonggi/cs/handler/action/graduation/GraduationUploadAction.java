...
public class GraduationUploadAction implements Action{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception{
		//30MB 제한
			   ...
			   String stage1 = request.getParameter("stage"); //스테이지 중간3,기말4,기타3개
			   
			    // 웹서버 컨테이너 경로
			   String folder="";
			  int s = Integer.parseInt(stage1);
			  if(s==3) {
			  ...
			  File dircheck = new File(path);
			    ...
			    GraduationTestDAO newdao = GraduationTestDAO.getInstance();
			    try{
			       ...
			       // newdao.insertFile(newFileName,Integer.parseInt(writer), sta);
			        newdao.insertFile(uploadFile,Integer.parseInt(writer), sta);
