...
public class GraduationFormInterimAction implements Action{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		request.setAttribute("download", GraduationTestDAO.getInstance().getDownloadFileName(1, perid));
		
		
		return "RequestDispatcher:jsp/graduation/form_mid_test.jsp";
	}
