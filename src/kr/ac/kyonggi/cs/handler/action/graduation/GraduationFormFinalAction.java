...
public class GraduationFormFinalAction implements Action{
	@Override
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception{
		...
		GraduationUserDTO grduser = GraduationTestDAO.getInstance().getUser(perid); //졸업생 graduationuser로 넘김
		...
		request.setAttribute("download", GraduationTestDAO.getInstance().getDownloadFileName(2, perid));
		
		
		return "RequestDispatcher:jsp/graduation/form_final_test.jsp";
	}
