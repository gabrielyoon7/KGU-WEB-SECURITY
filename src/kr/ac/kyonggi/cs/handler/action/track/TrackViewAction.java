...
public class TrackViewAction implements Action {
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        request.setAttribute("subject_19_1_1", gson.toJson(TrackDao.getInstance().getTrackSubjectByYear(2019, 1, 1)));
        request.setAttribute("subject_19_1_2", gson.toJson(TrackDao.getInstance().getTrackSubjectByYear(2019, 1, 2)));
        request.setAttribute("subject_19_2_1", gson.toJson(TrackDao.getInstance().getTrackSubjectByYear(2019, 2, 1)));
        request.setAttribute("subject_19_2_2", gson.toJson(TrackDao.getInstance().getTrackSubjectByYear(2019, 2, 2)));
        request.setAttribute("subject_19_3_1", gson.toJson(TrackDao.getInstance().getTrackSubjectByYear(2019, 3, 1)));
        request.setAttribute("subject_19_3_2", gson.toJson(TrackDao.getInstance().getTrackSubjectByYear(2019, 3, 2)));
        request.setAttribute("subject_19_4_1", gson.toJson(TrackDao.getInstance().getTrackSubjectByYear(2019, 4, 1)));
        request.setAttribute("subject_19_4_2", gson.toJson(TrackDao.getInstance().getTrackSubjectByYear(2019, 4, 2)));
        ...
        return "RequestDispatcher:jsp/track/track_view.jsp";
    }
}
