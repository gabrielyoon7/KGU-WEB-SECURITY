...
public class NoticeInsertBoardFileAction implements Action{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if(checkingImage == 0)
			...
			forArray2.add("<img src='uploadFile/noticeBoards/" + newFileName + "' style='width : 200px'><span style='font-size : 12px'> " + uploadFile + " 업로드 성공</span>");
