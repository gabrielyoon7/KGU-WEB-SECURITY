...
public class WebzineInsertBoardFileAction implements Action{
   ...
   public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
      ...
      int maxSize  = 1024*1024*50;       
       ...
       try{
           ...
           dao.insertFile(hexString.toString(), writer, uploadFile, newFileName);
      ...
      intoArray.addProperty("url", "webzine_file_upload_delete.do");
      ...
      if(checkingImage == 0)
			...
			forArray2.add("<img src='uploadFile/webzineBoards/" + newFileName + "' style='width : 200px'><span style='font-size : 12px'> " + uploadFile + " 업로드 성공</span>");
