...
public class ChangeLabImageAction implements Action{
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
	    ...
	    try{
	        ...
	        String LaboratoryID = multi.getParameter("LaboratoryID");
	        // 파일업로드
	        uploadFile = multi.getFilesystemName("uploadFile");
	        LaboratoryDAO dao = LaboratoryDAO.getInstance();
	        LaboratoryBean it = dao.getOneLaboratory(LaboratoryID);
