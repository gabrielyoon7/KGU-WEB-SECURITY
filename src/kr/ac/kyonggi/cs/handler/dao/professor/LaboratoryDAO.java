package kr.ac.kyonggi.cs.handler.dao.professor;
...
public class LaboratoryDAO {
   ...
   public ArrayList<LaboratoryBean> getLaboratory() {
      ...
      Gson gson = new Gson();
      ArrayList<LaboratoryBean> selected = gson.fromJson(gson.toJson(listOfMaps), new TypeToken<List<LaboratoryBean>>() {}.getType());
      return selected;
   }
   public LaboratoryBean getOneLaboratory(String data) {
      List<Map<String, Object>> listOfMaps = null;
      Connection conn = Config.getInstance().sqlLogin();
      try {
         QueryRunner queryRunner = new QueryRunner();
      ...
      Gson gson = new Gson();
      ArrayList<LaboratoryBean> results = gson.fromJson(gson.toJson(listOfMaps), new TypeToken<List<LaboratoryBean>>() {}.getType());
   ...
   public LaboratoryBean insertLaboratory(String data) {
