...
public class ProfessorDAO {
   ...
   public ArrayList<ProfessorBean> getProfessor() {
      ...
      Gson gson = new Gson();
      ArrayList<ProfessorBean> selected = gson.fromJson(gson.toJson(listOfMaps), new TypeToken<List<ProfessorBean>>() {}.getType());
      for(int i = 0; i < selected.size(); i++)
      {
      }
      return selected;
   }
   public ProfessorBean getOneProfessor(String data) {
      List<Map<String, Object>> listOfMaps = null;
      Connection conn = Config.getInstance().sqlLogin();
      try {
         QueryRunner queryRunner = new QueryRunner();
      ...
      Gson gson = new Gson();
      ArrayList<ProfessorBean> results = gson.fromJson(gson.toJson(listOfMaps), new TypeToken<List<ProfessorBean>>() {}.getType());
   ...
   public ProfessorBean insertProfessor(String data) {
