...
public class LockerApplyListAction  extends CustomAction {
...
//        }
        ...
        request.setAttribute("allAppliedStudents", gson.toJson(LockerDAO.getInstance().getAllAppliedStudents()));
        return "RequestDispatcher:jsp_v2/page/locker/locker_apply_list.jsp";
    }
}
