...
public class LockerManagerAction  extends CustomAction {
...
//        }
        ...
        request.setAttribute("locker", gson.toJson(LockerDAO.getInstance().getlockers(0)));
        request.setAttribute("info",gson.toJson(LockerDAO.getInstance().getinfo()));
        return "RequestDispatcher:jsp_v2/page/locker/locker_manager_list.jsp";
    }
}
