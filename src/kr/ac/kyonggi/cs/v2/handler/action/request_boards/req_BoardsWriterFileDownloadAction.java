...
public class req_BoardsWriterFileDownloadAction implements Action {
	...
	public String execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
	    ...
	    req_WriterFileBean it = dao.getWriterFile(id);
	    req_BoardsBean board = dao.getBoardRead(Integer.valueOf(it.board_id));
	    if(it == null)
	    	return null;
	    if(!board.level.contains(userType.for_header) && !board.student_id.equals(user.id) && userType.for_header.equals("관리자"))
	    	return null;
