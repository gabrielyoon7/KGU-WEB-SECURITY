...
<%
	StringBuffer url2_na_modifier = request.getRequestURL();
	String logo_img_na_modifier;

	//로컬에서는 http:// local~ 로컬 테스트를 위해 equals "lo" 추가
	//ai이면 ai로고 cs이면 cs로고
	if(url2_na_modifier.substring(7,9).equals("ai") || url2_na_modifier.substring(7,9).equals("lo")){
		logo_img_na_modifier = "img/notice_ai.png";
	}
	else{
		logo_img_na_modifier = "img/notice.png";
	}
	//System.out.println((logo_img_na_modifier));
%>
<%
...
<meta charset="utf-8">
<title>공지사항 : 경기대학교 AI컴퓨터공학부</title>
