...
<div class="loginForm">
    <div class="container1">
        <form method="POST" action="login.do" id="login_form">
            ...
            <div class="login_cont">
                <input type="text" class="" name="id" id="id" placeholder="아이디를 입력하세요." autofocus
                       required>
                <br>
                <input type="submit" onclick="letsSubmit()" style="display:none">
                <input type="password" class="" name="password" id="password" placeholder="비밀번호를 입력하세요.">
    ...
    <div class="container2" style="text-align: center">
        <div style="display: inline-block; margin-right:10px;">
            <input type="submit" value="로그인" id="send" onclick="letsSubmit()" />
        </div>
        <div style="display: inline-block">
            <input type="submit" value="회원가입" id="new" onclick="window.location.href='register.do'"/>
        </div>
    </div>
</div>
</body>
