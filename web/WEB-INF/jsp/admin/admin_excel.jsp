...
<%
   StringBuffer url2_admin_excel = request.getRequestURL();
   String logo_img_admin_excel;

   //로컬에서는 http:// local~ 로컬 테스트를 위해 equals "lo" 추가
   //ai이면 ai로고 cs이면 cs로고
   if(url2_admin_excel.substring(7,9).equals("ai") || url2_admin_excel.substring(7,9).equals("lo")){
      logo_img_admin_excel = "img/notice_ai.png";
   }
   else{
      logo_img_admin_excel = "img/notice.png";
   }
   //System.out.println((logo_img_admin_excel));
%>
<%
      ...
      <div id="container">
         ...
         <div id="maincontent">
            ...
            <div class="col-md-6">
               ...
               <a href="excel.do?writeorread=write" class="btn btn-default col-md-2">Excel로 보내기</a>
