   ...
   for (var i = 0; i < tabmenu.length; ++i) {
    ...
    var stage_data=<%=stage_data%>;//데이터정보
     ...
     if(modify==1){//name(answer_1), checked_value(answer_2), keyword(answer_3), content(answer_4)
       ...
       var a='';  
       a+='<ul><li><div style="display : flex"><div class="profile">제목</div><div class="form-group"><input type="text" class="form-control" id="final_name" placeholder="제목을 입력하세요" value="' + stage_data.answer_1 + '" style="width : 620px"></div></div></li>';
      ...
      a+= '<div><div class="form-group"><input type="number" class="form-control" id="final_page" style="width : 80px" value="' + stage_data.answer_4 + '"></div></div><div style="margin-left : 5px;">쪽</div><div style="font-size: 11px; margin-left: 5px">(서론/본론/결론/참고문헌 부분 쪽수, 표지/목차 제외)</div>';   
      ...
      a+=   '</ul>';
       modifymain.html(a);  
       var value=stage_data.answer_3.split("/");
         for(var i=0;i<value.length;i++){
          ...
          sign.html(b);
          a+='<ul><li><div style="width:709px;"><div class="profile">제목 </div><div class="inform">'+stage_data.answer_1+'</div></div></li>';
         a+=   '<li><div id="thesis_what" style="display:flex"><div class="profile">구분</div></div></li>';//필요
         a+=   '<li><div style="display:flex"><div class="profile" style="padding-top : 40px">자격요건</div>';
         ...
         a+=   '<div class="checkbox"><label><input type="checkbox" id="chkbox" class="chkbox" value="본인이 직접 작성한 파일임을 확인함" disabled>본인이 직접 작성한 파일임을 확인함</label></div>';
         a+=   '</div></div></li>';
         a+=   '<li><div style="display:flex"><div class="profile">쪽수</div><div style="text-align : left; margin-left : 5px;">'+stage_data.answer_4+' 쪽 </div>';
         a+=   '<div style="font-size:11px;margin-left:5px">(서론/본론/결론/참고문헌 부분 쪽수, 표지/목차 제외)</div></div></li>';
         a+=   '<li><div id="uploadfile1" style="display:flex"><div class="profile">파일제출</div>';
         a+='<div style="margin-left:5px">'+download[0]+'</div><div id="dele1" style="margin-left:5px"><a href="download.do?id='+stage_data.answer_5+'"><button class="btn btn-default" style="padding : 3px 10px; margin-left : 10px"><img src="img/downloadBtn.png"></button></a></div></div></li>';   
         modifymain.html(a);  
         var value=stage_data.answer_3.split("/");
         for(var i=0;i<value.length;i++){
            $('input:checkbox.chkbox').each(function(){
