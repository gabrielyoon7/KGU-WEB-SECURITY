...
<body>
   ...
   var stage_data=<%=stage_data%>;//데이터정보
     if(modify==1){//name(answer_1), checked_value(answer_2), keyword(answer_3), content(answer_4)
       ...
       var a='';  
       memory = [];
       var keyword=stage_data.answer_3.split("/");
         a+='<ul>';
       a+='<li><div style="display: flex"><div class="profile">제목</div><div class="form-group"><input type="text" class="form-control" id="suggest_name" placeholder="제목을 입력하세요" style="width : 620px" value="' + stage_data.answer_1 + '"></div></div></li>';
       a+='<li>';
       ...
       a+='</div></li>';
       a+='<li><div style="display: flex"><div class="profile">내용</div><div class="form-group" style="display : inline-block; width : 620px"><textarea class="form-control" id="suggest_content" rows=10>'+stage_data.answer_4+'</textarea></div></div></li></ul>'; 
       modifymain.html(a);
       keyword_count = keyword.length;
          ...
          var keyword=stage_data.answer_3.split("/");
          a+='<ul>';
          a+='<li><div style="width:709px;"><div class="profile">제목 </div><div class="inform">'+stage_data.answer_1+'</div></div></li>';
          ...
          a+='</div>'
          a+='<li><div style="display: flex"><div class="profile">내용 </div><div class="inform">'+stage_data.answer_4+'</div></div></li></ul>';
          modifymain.html(a);  
      }
