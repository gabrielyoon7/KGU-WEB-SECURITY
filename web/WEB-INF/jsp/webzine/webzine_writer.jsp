...
<%
   StringBuffer url2_wz_writer = request.getRequestURL();
   String logo_img_wz_writer;

   //로컬에서는 http:// local~ 로컬 테스트를 위해 equals "lo" 추가
   //ai이면 ai로고 cs이면 cs로고
   if(url2_wz_writer.substring(7,9).equals("ai") || url2_wz_writer.substring(7,9).equals("lo")){
      logo_img_wz_writer = "img/webzine_ai.png";
   }
   else{
      logo_img_wz_writer = "img/webzine.png";
   }
   //System.out.println((logo_img_wz_writer));
%>
<% 
