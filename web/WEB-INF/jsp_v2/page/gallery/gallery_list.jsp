...
float : right !important;
   ...
   if(<%=type%>.board_level <= 7){
	   ...
	   write.append( '<a href="gallery_board_writer.kgu?num='+num+'" class="btn btn-default">글쓰기</a>');
   }
   var moremore = 1;
  ...
  function formatDate(date) {
   ...
   function firstImages(){
      ...
      for(var i = 0 ; i < moremore * 10 ; ++i ){
            ...
            $('#view1_div'+sequence).append('<a href="gallery_board_reader.kgu?id='+value.id+'&num='+ num +'" id="aNumber' + i + '"></a>');
            var forTitle = '';
   ...
   function data(){
      ...
      for(var i=0;i<boards.length;i++){
         ...
         rows.push({
           board_id: value.id,
           title: '<a href="gallery_board_reader.kgu?id='+value.id+'&num='+ num +'">'+forTitle+'</a>',
